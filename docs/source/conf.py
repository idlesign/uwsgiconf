# -*- coding: utf-8 -*-
#
# uwsgiconf documentation build configuration file.
#
...
project = u'uwsgiconf'
copyright = u'2017-2018, Igor `idle sign` Starikov'
...
htmlhelp_basename = 'uwsgiconfdoc'
...
latex_documents = [
  ('index', 'uwsgiconf.tex', u'uwsgiconf Documentation',
...
man_pages = [
    ('index', 'uwsgiconf', u'uwsgiconf Documentation',
